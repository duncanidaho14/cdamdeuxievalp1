...
class ProduitController extends AbstractController
{
     ...
     * @Security("is_granted('ROLE_USER') and user === produit.getAuthor()", message="Cette annonce ne vous appartient pas, vous ne pouvez pas la modifier") 
     * 
     ...
     * @return Response
     */
    public function edit($id, Produit $produit, Request $request, EntityManagerInterface $manager): Response
    {
