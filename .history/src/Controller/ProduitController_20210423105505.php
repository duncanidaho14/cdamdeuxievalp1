...
class ProduitController extends AbstractController
{
     ...
     * Undocumented function
     * 
     * @Route("/produit/edit/{$id<\d+>}", name="produit_edit", methods={"GET, POST, PATCH"})
    ...
    /**
     * Remove produit
     * @Route("/produit/remove", name="produit_remove")
     * @param Produit $produit
     * @param EntityManagerInterface $manager
     * @return Response
     */
    public function remove(User $user, Produit $produit, EntityManagerInterface $manager): Response
    {
        $user = $this->getUser();

        $manager->remove($produit->getId());
        $manager->flush();
        return $this->render('produit/remove.html.twig');
    }
